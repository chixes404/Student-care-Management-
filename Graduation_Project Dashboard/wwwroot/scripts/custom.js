        ...
        $('.datatable').DataTable({
            buttons: {
                ...
                buttons: [
                    {
                        extend: 'copyHtml5',
                        text: '<i class="icon-copy3 mr-2"></i>',
                        titleAttr: 'Copy',
                    ...
                    {
                        extend: 'excelHtml5',
                        text: '<i class="icon-file-excel mr-2"></i>',
                        titleAttr: 'Excel',
                        className: 'btn btn-primary',
                        exportOptions: {
                            columns: ':visible'
                    ...
                    {
                        extend: 'pdfHtml5',
                        text: '<i class="icon-file-pdf mr-2"></i>',
                        titleAttr: 'PDF',
                        className: 'btn btn-primary',
                        exportOptions: {
                            columns: ':visible'
                    ...
                    {
                        extend: 'print',
                        text: '<i class="icon-printer mr-2"></i>',
                        titleAttr: 'Print',
                        className: 'btn btn-primary',
                        exportOptions: {
                            columns: ':visible'
                    ...
                    },
                    {
                        ...
                        titleAttr: 'Columns',
                        className: 'btn btn-teal dropdown-toggle'
                    }
        ...
        $('.datatable-users').DataTable({
            buttons: {
                ...
                buttons: [
                    ...
                    {
                        extend: 'colvis',
                        text: '<i class="icon-three-bars"></i> Columns',
                        className: 'btn btn-teal dropdown-toggle'
                    }
...
const CKEditorClassic = function () {
    ...
    const _componentCKEditorClassic = function () {
        ...
        ClassicEditor.create(document.querySelector('.ckeditor_classic_text'), {
            heading: {
                options: [
        ...
        //// Readonly editor
        //ClassicEditor.create(document.querySelector('.ckeditor_classic_text_readonly'), {
        //    heading: {
        //        options: [
        //            { model: 'paragraph', title: 'Paragraph', class: 'ck-heading_paragraph' },
        //            { model: 'heading1', view: 'h1', title: 'Heading 1', class: 'ck-heading_heading1' },
        ...
        //        ]
        //    }//,
        //    //removePlugins: ['toolbar','CKFinderUploadAdapter', 'CKFinder', 'EasyImage', 'Image', 'ImageCaption', 'ImageStyle', 'ImageToolbar', 'ImageUpload', 'MediaEmbed']
        //}).then(editor => {
        //    window.editor = editor;
        //    editor.enableReadOnlyMode('.ckeditor_classic_text_readonly');
...
const FullCalendarBasic = function () {
    ...
    // Basic calendar
    const _componentFullCalendarBasic = function (bookings) {
        ...
        const formattedBookings = bookings.map(booking => ({
            ...
            MobilePhone: `${booking.mobileNumber}`,
    ...
    return {
        init: function (bookings) {
            _componentFullCalendarBasic(bookings);
        }
    }
}();
