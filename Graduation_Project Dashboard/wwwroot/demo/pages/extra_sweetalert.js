        ...
        if(swalBackgroundElement) {
            swalBackgroundElement.addEventListener('click', function() {
                swalInit.fire({
                    ...
                    background: !document.documentElement.getAttribute('data-color-theme') || document.documentElement.getAttribute('data-color-theme') == 'light' ? '#fff url("images/demo/pattern.png") repeat' : '#383940 url("images/demo/pattern.png") repeat',
                });
            });
        }
